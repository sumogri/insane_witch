...
このエンドでは、依代燐は守られただけで、自分の意思で強く合体に反対できていないことが予想されます。
そのため、彼女の中に罪悪感が残ります。
...
あなたの【本当の使命】は、クライマックスフェイズ開始前までに、互いに【愛情】の感情を持つ相手を1人選び、そのキャラクターを戦闘脱落させないことである。
...
アビリティ【青春】
サポート 指定特技【暗黒】
ラウンドの終了時に使用できる。アビリティ【戦場移動】を使用できる。
...
アビリティ【白秋】
サポート 指定特技【夢】
支援行動。目標を一人選ぶ。そのキャラクターを目標としているサポートアビリティの効果を1つ選び、無効にする。

注:このアビリティが発動したタイミングで発動している効果を無効にする。予防的に発動はしない。
たとえば「かばう」の対象となりうるキャラクターに使用しても、その瞬間に「かばう」の効果は発動していないため、無効にする効果は発動しない。
